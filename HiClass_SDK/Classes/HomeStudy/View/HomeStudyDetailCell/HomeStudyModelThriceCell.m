...
#define ModelThriceCellTag 300000

@interface HomeStudyModelThriceCell ()
...
@implementation HomeStudyModelThriceCell
...
//    }
    ...
    CGFloat imageWidth = (HIC_ScreenWidth - 16*2 - 12.5*2)/3;
    ...
    for (NSInteger i = 0; i < homeStudyModel.resourceList.count; i++) {
        NSInteger l = i%3;
        NSInteger n = i/3;
        UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(16 + l*imageWidth + l*12.5, titleTop+n*(imageHeight + 8 + titleHeight + 12), imageWidth, imageHeight)];
        ...
        UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(16 + l*imageWidth + l*12.5, titleTop +imageHeight + 8+n*(imageHeight + 8 + titleHeight + 12), imageWidth, titleHeight)];
...
-(void)clickBackBut:(UIButton *)btn {
    ...
    NSInteger index = btn.tag - ModelThriceCellTag;
