...
#import "HICQuestionWaitView.h"
#import "HICQuestionCell.h"
#import "HICQuestionModel.h"
#import "HICTrainQuestionVC.h"
static NSString *questionWait = @"questionWait";
@interface HICQuestionWaitView ()<UITableViewDelegate,UITableViewDataSource>

@end
@implementation HICQuestionWaitView
- (instancetype)init {
    if (self = [super init]) {
        [self createUI];
    }
...
- (void)configTableView {
    ...
    [self registerClass:[HICQuestionCell class] forCellReuseIdentifier:questionWait];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    HICQuestionCell *cell = (HICQuestionCell *)[tableView dequeueReusableCellWithIdentifier:questionWait forIndexPath:indexPath];
    cell.isAll = NO;
