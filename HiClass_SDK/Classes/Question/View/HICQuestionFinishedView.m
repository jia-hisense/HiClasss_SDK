...
#import "HICQuestionFinishedView.h"
#import "HICQuestionCell.h"
#import "HICQuestionModel.h"
#import "HICTrainQuestionVC.h"
static NSString *questionFinished = @"questionFinished";
@interface HICQuestionFinishedView ()<UITableViewDelegate,UITableViewDataSource>

@end
@implementation HICQuestionFinishedView
- (instancetype)init {
    if (self = [super init]) {
        [self createUI];
    }
...
- (void)configTableView{
    ...
    [self registerClass:[HICQuestionCell class] forCellReuseIdentifier:questionFinished];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    HICQuestionCell *cell = (HICQuestionCell *)[tableView dequeueReusableCellWithIdentifier:questionFinished forIndexPath:indexPath];
    cell.isAll = NO;
