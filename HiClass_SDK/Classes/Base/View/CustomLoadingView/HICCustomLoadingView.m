...
@interface HICCustomLoadingView ()
...
@implementation HICCustomLoadingView

+(instancetype)createLoadingViewWith:(CGRect)frame onView:(UIView *)parentView {

    HICCustomLoadingView *view = [[HICCustomLoadingView alloc] initWithFrame:frame];
...
-(void)createLoadingImageWith:(CGRect)frame {
    ...
    label.text = NSLocalizableString(@"InTheLoad", nil);
