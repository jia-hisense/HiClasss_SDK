...
static NSString *enrollWaitID = @"enrollWaitID";
@interface HICEnrollWaitView ()<UITableViewDelegate,UITableViewDataSource>

@end
@implementation HICEnrollWaitView
- (instancetype)init {
    if (self = [super init]) {
        [self createUI];
    }
...
- (void)configTableView{
    ...
    [self registerClass:[HICEnrollListCell class] forCellReuseIdentifier:enrollWaitID];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    HICEnrollListCell *cell = (HICEnrollListCell *)[tableView dequeueReusableCellWithIdentifier:enrollWaitID];
       if (cell == nil) {
           cell = [[HICEnrollListCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:enrollWaitID];
       }
