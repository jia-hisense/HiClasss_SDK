...
static NSString *enrolledID = @"enrolledID";
@interface HICEnrolledView ()<UITableViewDelegate,UITableViewDataSource>

@end
@implementation HICEnrolledView
...
- (void)configTableView{
    ...
    [self registerClass:[HICEnrollListCell class] forCellReuseIdentifier:enrolledID];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    HICEnrollListCell *cell = (HICEnrollListCell *)[tableView dequeueReusableCellWithIdentifier:enrolledID];
    if (cell == nil) {
        cell = [[HICEnrollListCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:enrolledID];
    }
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (model.userRegisterStatus == HICFormalStudent) {
        return 104.5 + 12;
    }else if (model.userRegisterStatus == HICSubstituteStudent|| model.userRegisterStatus == HICEnrollFaild || model.userRegisterStatus == HICCancelQualification){
        return 154.5 + 12;
    }else{
        return 124.5 + 12;
    }
