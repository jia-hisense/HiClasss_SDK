 ...
 */
@interface BMSDImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<BMSDImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<BMSDImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage NS_SWIFT_NAME(frames(from:));
