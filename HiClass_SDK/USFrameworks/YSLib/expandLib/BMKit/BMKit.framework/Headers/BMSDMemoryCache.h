 ...
 */
- (nonnull instancetype)initWithConfig:(nonnull BMSDImageCacheConfig *)config;
 ...
 */
@interface BMSDMemoryCache <KeyType, ObjectType> : NSCache <KeyType, ObjectType> <BMSDMemoryCache>

@property (nonatomic, strong, nonnull, readonly) BMSDImageCacheConfig *config;
