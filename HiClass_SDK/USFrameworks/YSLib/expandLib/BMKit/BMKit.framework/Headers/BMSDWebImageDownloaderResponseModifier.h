...
typedef NSURLResponse * _Nullable (^BMSDWebImageDownloaderResponseModifierBlock)(NSURLResponse * _Nonnull response);
 ...
 */
@protocol BMSDWebImageDownloaderResponseModifier <NSObject>
 ...
 */
@interface BMSDWebImageDownloaderResponseModifier : NSObject <BMSDWebImageDownloaderResponseModifier>

/// Create the response modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull BMSDWebImageDownloaderResponseModifierBlock)block;

/// Create the response modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)responseModifierWithBlock:(nonnull BMSDWebImageDownloaderResponseModifierBlock)block;
...
*/
@interface BMSDWebImageDownloaderResponseModifier (Conveniences)
