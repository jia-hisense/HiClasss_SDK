...
#import "BMSDWebImageDownloaderRequestModifier.h"
...
typedef NS_OPTIONS(NSUInteger, BMSDWebImageDownloaderOptions) {
     ...
     */
    BMSDWebImageDownloaderProgressiveLoad = 1 << 1,
     ...
     */
    BMSDWebImageDownloaderPreloadAllFrames = 1 << 11,
...
FOUNDATION_EXPORT NSNotificationName _Nonnull const BMSDWebImageDownloadReceiveResponseNotification;
FOUNDATION_EXPORT NSNotificationName _Nonnull const BMSDWebImageDownloadStopNotification;
FOUNDATION_EXPORT NSNotificationName _Nonnull const BMSDWebImageDownloadFinishNotification;

typedef BMSDImageLoaderProgressBlock BMSDWebImageDownloaderProgressBlock;
typedef BMSDImageLoaderCompletedBlock BMSDWebImageDownloaderCompletedBlock;

/**
 *  A token associated with each download. Can be used to cancel a download
 */
@interface BMSDWebImageDownloadToken : NSObject <BMSDWebImageOperation>
 ...
 */
@interface BMSDWebImageDownloader : NSObject
 ...
 */
@property (nonatomic, copy, readonly, nonnull) BMSDWebImageDownloaderConfig *config;
 ...
 */
@property (nonatomic, strong, nullable) id<BMSDWebImageDownloaderRequestModifier> requestModifier;
 ...
 */
@property (nonatomic, strong, nullable) id<BMSDWebImageDownloaderResponseModifier> responseModifier;
 ...
 */
@property (nonatomic, strong, nullable) id<BMSDWebImageDownloaderDecryptor> decryptor;
 ...
 */
@property (nonatomic, class, readonly, nonnull) BMSDWebImageDownloader *sharedDownloader;
 ...
 */
- (nonnull instancetype)initWithConfig:(nullable BMSDWebImageDownloaderConfig *)config NS_DESIGNATED_INITIALIZER;
 ...
 */
@interface BMSDWebImageDownloader (SDImageLoader) <BMSDImageLoader>
