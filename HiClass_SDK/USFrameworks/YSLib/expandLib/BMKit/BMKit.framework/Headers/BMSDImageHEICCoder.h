...
@interface BMSDImageHEICCoder : BMSDImageIOAnimatedCoder <BMSDProgressiveImageCoder, BMSDAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) BMSDImageHEICCoder *sharedCoder;
