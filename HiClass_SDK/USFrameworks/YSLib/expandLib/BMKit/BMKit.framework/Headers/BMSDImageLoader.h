 ...
 */
FOUNDATION_EXPORT BMSDWebImageContextOption _Nonnull const BMSDWebImageContextLoaderCachedImage;
 ...
 */
FOUNDATION_EXPORT UIImage * _Nullable BMSDImageLoaderDecodeImageData(NSData * _Nonnull imageData, NSURL * _Nonnull imageURL, BMSDWebImageOptions options, BMSDWebImageContext * _Nullable context);
...
*/
@protocol BMSDImageLoader <NSObject>
...
- (nullable id<BMSDWebImageOperation>)requestImageWithURL:(nullable NSURL *)url
                                              ...
                                              completed:(nullable BMSDImageLoaderCompletedBlock)completedBlock;
