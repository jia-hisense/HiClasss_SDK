 ...
 */
@interface BMSDImageCodersManager : NSObject <BMSDImageCoder>

/**
 Returns the global shared coders manager instance.
 */
@property (nonatomic, class, readonly, nonnull) BMSDImageCodersManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<BMSDImageCoder>> *coders;
