 ...
 */
@property (nonatomic, strong, readonly, nullable) NSURL *bmsd_currentImageURL;
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSURL *bmsd_currentBackgroundImageURL;
