...
typedef NSString * BMSDImageCoderOption NS_STRING_ENUM;
typedef NSDictionary<BMSDImageCoderOption, id> BMSDImageCoderOptions;
typedef NSMutableDictionary<BMSDImageCoderOption, id> BMSDImageCoderMutableOptions;
 ...
 */
FOUNDATION_EXPORT BMSDImageCoderOption _Nonnull const BMSDImageCoderDecodeFirstFrameOnly;
 ...
 */
FOUNDATION_EXPORT BMSDImageCoderOption _Nonnull const BMSDImageCoderDecodeScaleFactor;
...
/**
 ...
 @note works for `SDImageCoder`, `SDProgressiveImageCoder`, `SDAnimatedImageCoder`.
 */
FOUNDATION_EXPORT BMSDImageCoderOption _Nonnull const BMSDImageCoderDecodePreserveAspectRatio;
...
/**
 ...
 @note works for `SDImageCoder`, `SDProgressiveImageCoder`, `SDAnimatedImageCoder`.
 */
FOUNDATION_EXPORT BMSDImageCoderOption _Nonnull const BMSDImageCoderDecodeThumbnailPixelSize;
...
/**
 ...
 @note works for `SDImageCoder`.
 */
FOUNDATION_EXPORT BMSDImageCoderOption _Nonnull const BMSDImageCoderEncodeFirstFrameOnly;
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT BMSDImageCoderOption _Nonnull const BMSDImageCoderEncodeCompressionQuality;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT BMSDImageCoderOption _Nonnull const BMSDImageCoderEncodeBackgroundColor;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT BMSDImageCoderOption _Nonnull const BMSDImageCoderEncodeMaxPixelSize;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT BMSDImageCoderOption _Nonnull const BMSDImageCoderEncodeMaxFileSize;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT BMSDImageCoderOption _Nonnull const BMSDImageCoderEncodeEmbedThumbnail;
 ...
 */
FOUNDATION_EXPORT BMSDImageCoderOption _Nonnull const BMSDImageCoderWebImageContext API_DEPRECATED("The coder component will be seperated from Core subspec in the future. Update your code to not rely on this context option.", macos(10.10, API_TO_BE_DEPRECATED), ios(8.0, API_TO_BE_DEPRECATED), tvos(9.0, API_TO_BE_DEPRECATED), watchos(2.0, API_TO_BE_DEPRECATED));
 ...
 */
@protocol BMSDImageCoder <NSObject>
...
- (nullable UIImage *)decodedImageWithData:(nullable NSData *)data
                                   options:(nullable BMSDImageCoderOptions *)options;
 ...
 */
- (BOOL)canEncodeToFormat:(BMSDImageFormat)format NS_SWIFT_NAME(canEncode(to:));
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol BMSDProgressiveImageCoder <BMSDImageCoder>
 ...
 */
- (nonnull instancetype)initIncrementalWithOptions:(nullable BMSDImageCoderOptions *)options;
 ...
 */
- (nullable UIImage *)incrementalDecodedImageWithOptions:(nullable BMSDImageCoderOptions *)options;
 ...
 */
@protocol BMSDAnimatedImageProvider <NSObject>
 ...
 */
@protocol BMSDAnimatedImageCoder <BMSDImageCoder, BMSDAnimatedImageProvider>
 ...
 */
- (nullable instancetype)initWithAnimatedImageData:(nullable NSData *)data options:(nullable BMSDImageCoderOptions *)options;
