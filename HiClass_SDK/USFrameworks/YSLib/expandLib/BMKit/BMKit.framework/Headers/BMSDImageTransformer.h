 ...
 */
FOUNDATION_EXPORT NSString * _Nullable BMSDTransformedKeyForKey(NSString * _Nullable key, NSString * _Nonnull transformerKey);
 ...
 */
FOUNDATION_EXPORT NSString * _Nullable BMSDThumbnailedKeyForKey(NSString * _Nullable key, CGSize thumbnailPixelSize, BOOL preserveAspectRatio);
 ...
 */
@protocol BMSDImageTransformer <NSObject>
 ...
 */
@interface BMSDImagePipelineTransformer : NSObject <BMSDImageTransformer>

/**
 All transformers in pipeline
 */
@property (nonatomic, copy, readonly, nonnull) NSArray<id<BMSDImageTransformer>> *transformers;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithTransformers:(nonnull NSArray<id<BMSDImageTransformer>> *)transformers;
 ...
 */
@interface BMSDImageRoundCornerTransformer: NSObject <BMSDImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) BMSDRectCorner corners;
...
- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithRadius:(CGFloat)cornerRadius corners:(BMSDRectCorner)corners borderWidth:(CGFloat)borderWidth borderColor:(nullable UIColor *)borderColor;
 ...
 */
@interface BMSDImageResizingTransformer : NSObject <BMSDImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) BMSDImageScaleMode scaleMode;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithSize:(CGSize)size scaleMode:(BMSDImageScaleMode)scaleMode;
 ...
 */
@interface BMSDImageCroppingTransformer : NSObject <BMSDImageTransformer>
 ...
 */
@interface BMSDImageFlippingTransformer : NSObject <BMSDImageTransformer>
 ...
 */
@interface BMSDImageRotationTransformer : NSObject <BMSDImageTransformer>
 ...
 */
@interface BMSDImageTintTransformer : NSObject <BMSDImageTransformer>
 ...
 */
@interface BMSDImageBlurTransformer : NSObject <BMSDImageTransformer>
 ...
 */
@interface BMSDImageFilterTransformer: NSObject <BMSDImageTransformer>
