...
@class BMStepperInputItem;
typedef void (^stepperInputValueChangeHandler)(BMStepperInputItem *item, BMStepperInputViewStepStatus stepStatus);

@interface BMStepperInputItem : BMTableViewItem
