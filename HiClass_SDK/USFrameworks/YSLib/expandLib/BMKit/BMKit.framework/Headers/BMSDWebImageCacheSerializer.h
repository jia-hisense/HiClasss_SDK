...
typedef NSData * _Nullable(^BMSDWebImageCacheSerializerBlock)(UIImage * _Nonnull image, NSData * _Nullable data, NSURL * _Nullable imageURL);
 ...
 */
@protocol BMSDWebImageCacheSerializer <NSObject>
 ...
 */
@interface BMSDWebImageCacheSerializer : NSObject <BMSDWebImageCacheSerializer>

- (nonnull instancetype)initWithBlock:(nonnull BMSDWebImageCacheSerializerBlock)block;
+ (nonnull instancetype)cacheSerializerWithBlock:(nonnull BMSDWebImageCacheSerializerBlock)block;
