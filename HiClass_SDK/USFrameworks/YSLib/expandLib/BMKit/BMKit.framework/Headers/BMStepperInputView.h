...
typedef NS_ENUM(NSUInteger, BMStepperInputViewStepStatus)
{
    BMStepperInputViewStepStatus_None,
    BMStepperInputViewStepStatus_Increase,
    BMStepperInputViewStepStatus_Decrease
};

typedef void(^BMStepperInputViewChangeBlock)(NSDecimalNumber *number, BMStepperInputViewStepStatus stepStatus);

@protocol BMStepperInputViewDelegate;

@interface BMStepperInputView : UIView

@property (nonatomic, weak) id<BMStepperInputViewDelegate> delegate;
...
@property (nonatomic, copy) BMStepperInputViewChangeBlock numberChangeBlock;

@end

@protocol BMStepperInputViewDelegate <NSObject>
