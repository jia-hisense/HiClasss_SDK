 ...
 */
@interface BMSDImageGIFCoder : BMSDImageIOAnimatedCoder <BMSDProgressiveImageCoder, BMSDAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) BMSDImageGIFCoder *sharedCoder;
