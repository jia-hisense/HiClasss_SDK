 ...
 */
@property (nonatomic, assign) NSUInteger bmsd_imageLoopCount;
 ...
 */
@property (nonatomic, assign, readonly) BOOL bmsd_isAnimated;
 ...
 */
@property (nonatomic, assign, readonly) BOOL bmsd_isVector;
 ...
 */
@property (nonatomic, assign) BMSDImageFormat bmsd_imageFormat;

/**
 A bool value indicating whether the image is during incremental decoding and may not contains full pixels.
 */
@property (nonatomic, assign) BOOL bmsd_isIncremental;
