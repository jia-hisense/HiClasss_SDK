...
typedef NSURLRequest * _Nullable (^BMSDWebImageDownloaderRequestModifierBlock)(NSURLRequest * _Nonnull request);
 ...
 */
@protocol BMSDWebImageDownloaderRequestModifier <NSObject>
 ...
 */
@interface BMSDWebImageDownloaderRequestModifier : NSObject <BMSDWebImageDownloaderRequestModifier>

/// Create the request modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull BMSDWebImageDownloaderRequestModifierBlock)block;

/// Create the request modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)requestModifierWithBlock:(nonnull BMSDWebImageDownloaderRequestModifierBlock)block;
...
*/
@interface BMSDWebImageDownloaderRequestModifier (Conveniences)
