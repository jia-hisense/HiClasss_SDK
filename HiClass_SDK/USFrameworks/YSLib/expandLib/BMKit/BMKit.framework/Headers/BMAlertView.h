...
@property (nonatomic, strong, readonly) UIVisualEffectView *alertMaskBgEffectView;
@property (nullable, nonatomic, strong) UIVisualEffect *alertMaskBgEffect;
@property (nonatomic, strong) UIColor *alertMaskBgColor;
