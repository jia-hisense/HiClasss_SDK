 ...
 */
@protocol BMSDWebImageDownloaderOperation <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
@required
 ...
 */
@interface BMSDWebImageDownloaderOperation : NSOperation <BMSDWebImageDownloaderOperation>
 ...
 */
@property (copy, nonatomic, readonly, nullable) BMSDWebImageContext *context;
...
- (nonnull instancetype)initWithRequest:(nullable NSURLRequest *)request
                              inSession:(nullable NSURLSession *)session
                                options:(BMSDWebImageDownloaderOptions)options
                                context:(nullable BMSDWebImageContext *)context NS_DESIGNATED_INITIALIZER;
