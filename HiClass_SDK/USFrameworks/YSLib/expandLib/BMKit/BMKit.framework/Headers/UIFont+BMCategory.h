 ...
 */
typedef NS_ENUM(NSInteger, BMFamilyFontName)
{
    /**
 ...
 */
typedef NS_ENUM(NSInteger, BMFontName) {
    /**
     *  SystemFont
     */
    FontNameSystemFont = 0,
    /**
     *  Academy Engraved Let Plain
     */
    FontNameAcademyEngravedLetPlain,
    /**
     *  Al Nile
     */
    FontNameAlNile,
    ...
    *  PingFang-SC-Medium
    */
    FontNamePingFangSCMedium,
    /**
    *  PingFang-SC-Semibold
    */
    FontNamePingFangSCSemibold,
    /**
    *  PingFang-SC-Light
    */
    FontNamePingFangSCLight,
    /**
    *  PingFang-SC-Ultralight
    */
    FontNamePingFangSCUltralight,
    /**
    *  PingFang-SC-Regular
    */
    FontNamePingFangSCRegular,
    /**
    *  PingFang-SC-Thin
    */
    FontNamePingFangSCThin
...
@interface UIFont (BMCategory)

// 所有字体名称
+ (nonnull NSDictionary *)bm_allFamilyAndFonts;
// 一组字体名称
+ (nonnull NSArray *)bm_fontsNameForFamilyName:(BMFamilyFontName)familyFontName;


+ (nullable UIFont *)bm_fontForFontName:(BMFontName)fontName
                                size:(CGFloat)fontSize;

+ (nullable NSString *)bm_fontNameToString:(BMFontName)fontName;


- (nullable UIFont *)bm_fontWithBold NS_AVAILABLE_IOS(7_0);

- (nullable UIFont *)bm_fontWithItalic NS_AVAILABLE_IOS(7_0);

- (nullable UIFont *)bm_fontWithBoldItalic NS_AVAILABLE_IOS(7_0);

- (nullable UIFont *)bm_fontWithNormal NS_AVAILABLE_IOS(7_0);
