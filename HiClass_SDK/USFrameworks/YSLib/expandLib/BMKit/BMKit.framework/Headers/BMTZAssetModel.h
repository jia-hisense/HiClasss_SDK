...
typedef enum : NSUInteger {
    BMTZAssetModelMediaTypePhoto = 0,
    BMTZAssetModelMediaTypeLivePhoto,
    BMTZAssetModelMediaTypePhotoGif,
    BMTZAssetModelMediaTypeVideo,
    BMTZAssetModelMediaTypeAudio
} BMTZAssetModelMediaType;

@class PHAsset;
@interface BMTZAssetModel : NSObject

@property (nonatomic, strong) PHAsset *asset;
@property (nonatomic, assign) BOOL isSelected;      ///< The select status of a photo, default is No
@property (nonatomic, assign) BMTZAssetModelMediaType type;
...
@class PHFetchResult;
@interface BMTZAlbumModel : NSObject
