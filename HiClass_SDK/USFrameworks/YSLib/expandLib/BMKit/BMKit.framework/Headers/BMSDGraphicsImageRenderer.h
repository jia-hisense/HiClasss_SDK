...
typedef void (^BMSDGraphicsImageDrawingActions)(CGContextRef _Nonnull context);
typedef NS_ENUM(NSInteger, BMSDGraphicsImageRendererFormatRange) {
    BMSDGraphicsImageRendererFormatRangeUnspecified = -1,
    BMSDGraphicsImageRendererFormatRangeAutomatic = 0,
    BMSDGraphicsImageRendererFormatRangeExtended,
    BMSDGraphicsImageRendererFormatRangeStandard
};

/// A set of drawing attributes that represent the configuration of an image renderer context.
@interface BMSDGraphicsImageRendererFormat : NSObject
...
@property (nonatomic) BMSDGraphicsImageRendererFormatRange preferredRange;
...
@interface BMSDGraphicsImageRenderer : NSObject
...
/// @return An initialized image renderer.
- (nonnull instancetype)initWithSize:(CGSize)size format:(nonnull BMSDGraphicsImageRendererFormat *)format;
...
- (nonnull UIImage *)imageWithActions:(nonnull NS_NOESCAPE BMSDGraphicsImageDrawingActions)actions;
