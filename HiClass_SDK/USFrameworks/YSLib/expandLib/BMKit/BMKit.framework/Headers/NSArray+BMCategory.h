...
- (NSUInteger)bm_findFirstObjectIndexWithKey:(nonnull NSString *)key value:(nonnull id)value;
- (nullable id)bm_findFirstObjectWithKey:(nonnull NSString *)key value:(nonnull id)value;
