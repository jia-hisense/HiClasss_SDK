 ...
 */
FOUNDATION_EXPORT const int64_t BMSDWebImageProgressUnitCountUnknown; /* 1LL */

typedef void(^BMSDSetImageBlock)(UIImage * _Nullable image, NSData * _Nullable imageData, BMSDImageCacheType cacheType, NSURL * _Nullable imageURL);
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSURL *bmsd_imageURL;
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSString *bmsd_latestOperationKey;
 ...
 */
@property (nonatomic, strong, null_resettable) NSProgress *bmsd_imageProgress;
 ...
 */
@property (nonatomic, strong, nullable) BMSDWebImageTransition *bmsd_imageTransition;
 ...
 */
@property (nonatomic, strong, nullable) id<BMSDWebImageIndicator> bmsd_imageIndicator;
