 ...
 */
@protocol BMSDDiskCache <NSObject>
 ...
 */
- (nullable instancetype)initWithCachePath:(nonnull NSString *)cachePath config:(nonnull BMSDImageCacheConfig *)config;
 ...
 */
@interface BMSDDiskCache : NSObject <BMSDDiskCache>
/**
 Cache Config object - storing all kind of settings.
 */
@property (nonatomic, strong, readonly, nonnull) BMSDImageCacheConfig *config;
