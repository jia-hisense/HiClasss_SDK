 ...
 */
@interface BMSDImageCacheConfig : NSObject <NSCopying>
 ...
 */
@property (nonatomic, class, readonly, nonnull) BMSDImageCacheConfig *defaultCacheConfig;
 ...
 */
@property (assign, nonatomic) BMSDImageCacheConfigExpireType diskCacheExpireType;
