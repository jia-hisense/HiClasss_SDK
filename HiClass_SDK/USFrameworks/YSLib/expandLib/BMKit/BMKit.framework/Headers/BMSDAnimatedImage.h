 ...
 */
@protocol BMSDAnimatedImage <BMSDAnimatedImageProvider>
 ...
 */
- (nullable instancetype)initWithData:(nonnull NSData *)data scale:(CGFloat)scale options:(nullable BMSDImageCoderOptions *)options;
...
/**
 ...
 @return An initialized object
 */
- (nullable instancetype)initWithAnimatedCoder:(nonnull id<BMSDAnimatedImageCoder>)animatedCoder scale:(CGFloat)scale;
...
/**
 ...
 @note We use this with animated coder which conforms to `SDProgressiveImageCoder` for progressive animation decoding.
 */
@property (nonatomic, strong, readonly, nullable) id<BMSDAnimatedImageCoder> animatedCoder;
 ...
 */
@interface BMSDAnimatedImage : UIImage <BMSDAnimatedImage>
 ...
 */
@property (nonatomic, assign, readonly) BMSDImageFormat animatedImageFormat;
