...
#if BMSD_UIKIT
typedef UIViewAnimationOptions BMSDWebImageAnimationOptions;
#else
typedef NS_OPTIONS(NSUInteger, BMSDWebImageAnimationOptions) {
    SDWebImageAnimationOptionAllowsImplicitAnimation   = 1 << 0, // specify `allowsImplicitAnimation` for the `NSAnimationContext`
    
    BMSDWebImageAnimationOptionCurveEaseInOut            = 0 << 16, // default
    BMSDWebImageAnimationOptionCurveEaseIn               = 1 << 16,
    BMSDWebImageAnimationOptionCurveEaseOut              = 2 << 16,
    BMSDWebImageAnimationOptionCurveLinear               = 3 << 16,
    
    BMSDWebImageAnimationOptionTransitionNone            = 0 << 20, // default
    BMSDWebImageAnimationOptionTransitionFlipFromLeft    = 1 << 20,
    BMSDWebImageAnimationOptionTransitionFlipFromRight   = 2 << 20,
    BMSDWebImageAnimationOptionTransitionCurlUp          = 3 << 20,
    BMSDWebImageAnimationOptionTransitionCurlDown        = 4 << 20,
    BMSDWebImageAnimationOptionTransitionCrossDissolve   = 5 << 20,
    BMSDWebImageAnimationOptionTransitionFlipFromTop     = 6 << 20,
    BMSDWebImageAnimationOptionTransitionFlipFromBottom  = 7 << 20,
};
#endif

typedef void (^BMSDWebImageTransitionPreparesBlock)(__kindof UIView * _Nonnull view, UIImage * _Nullable image, NSData * _Nullable imageData, BMSDImageCacheType cacheType, NSURL * _Nullable imageURL);
typedef void (^BMSDWebImageTransitionAnimationsBlock)(__kindof UIView * _Nonnull view, UIImage * _Nullable image);
typedef void (^BMSDWebImageTransitionCompletionBlock)(BOOL finished);
 ...
 */
@interface BMSDWebImageTransition : NSObject
 ...
 */
@property (nonatomic, assign) BMSDWebImageAnimationOptions animationOptions;
/**
 A block object to be executed before the animation sequence starts.
 */
@property (nonatomic, copy, nullable) BMSDWebImageTransitionPreparesBlock prepares;
/**
 A block object that contains the changes you want to make to the specified view.
 */
@property (nonatomic, copy, nullable) BMSDWebImageTransitionAnimationsBlock animations;
/**
 A block object to be executed when the animation sequence ends.
 */
@property (nonatomic, copy, nullable) BMSDWebImageTransitionCompletionBlock completion;
 ...
 */
@interface BMSDWebImageTransition (Conveniences)

/// Fade-in transition.
@property (nonatomic, class, nonnull, readonly) BMSDWebImageTransition *fadeTransition;
/// Flip from left transition.
@property (nonatomic, class, nonnull, readonly) BMSDWebImageTransition *flipFromLeftTransition;
/// Flip from right transition.
@property (nonatomic, class, nonnull, readonly) BMSDWebImageTransition *flipFromRightTransition;
/// Flip from top transition.
@property (nonatomic, class, nonnull, readonly) BMSDWebImageTransition *flipFromTopTransition;
/// Flip from bottom transition.
@property (nonatomic, class, nonnull, readonly) BMSDWebImageTransition *flipFromBottomTransition;
/// Curl up transition.
@property (nonatomic, class, nonnull, readonly) BMSDWebImageTransition *curlUpTransition;
/// Curl down transition.
@property (nonatomic, class, nonnull, readonly) BMSDWebImageTransition *curlDownTransition;
