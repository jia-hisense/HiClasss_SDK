...
@class BMSDWebImagePrefetcher;

/**
 A token represents a list of URLs, can be used to cancel the download.
 */
@interface BMSDWebImagePrefetchToken : NSObject <BMSDWebImageOperation>
 ...
 */
@protocol BMSDWebImagePrefetcherDelegate <NSObject>
 ...
 */
- (void)imagePrefetcher:(nonnull BMSDWebImagePrefetcher *)imagePrefetcher didPrefetchURL:(nullable NSURL *)imageURL finishedCount:(NSUInteger)finishedCount totalCount:(NSUInteger)totalCount;
 ...
 */
- (void)imagePrefetcher:(nonnull BMSDWebImagePrefetcher *)imagePrefetcher didFinishWithTotalCount:(NSUInteger)totalCount skippedCount:(NSUInteger)skippedCount;
 ...
 */
@interface BMSDWebImagePrefetcher : NSObject
 ...
 */
@property (strong, nonatomic, readonly, nonnull) BMSDWebImageManager *manager;
 ...
 */
@property (weak, nonatomic, nullable) id <BMSDWebImagePrefetcherDelegate> delegate;

/**
 * Returns the global shared image prefetcher instance. It use a standalone manager which is different from shared manager.
 */
@property (nonatomic, class, readonly, nonnull) BMSDWebImagePrefetcher *sharedImagePrefetcher;

/**
 * Allows you to instantiate a prefetcher with any arbitrary image manager.
 */
- (nonnull instancetype)initWithImageManager:(nonnull BMSDWebImageManager *)manager NS_DESIGNATED_INITIALIZER;
 ...
 */
- (nullable BMSDWebImagePrefetchToken *)prefetchURLs:(nullable NSArray<NSURL *> *)urls;
