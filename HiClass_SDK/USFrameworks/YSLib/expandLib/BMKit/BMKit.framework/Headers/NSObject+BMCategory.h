...
@interface NSObject (BMJson)

- (nullable NSDictionary *)bm_toDictionary;

- (nullable NSData *)bm_toJSONDataWithOptions:(NSJSONWritingOptions)options error:(NSError * _Nullable * _Nullable)error;
