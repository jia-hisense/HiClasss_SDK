...
- (void)bm_moveTo:(CGPoint)destination changeSize:(CGSize)size duration:(NSTimeInterval)secs delay:(NSTimeInterval)delay option:(UIViewAnimationOptions)option callbackBlock:(void(^)(void))block;
...
- (void)bm_raceTo:(CGPoint)destination changeSize:(CGSize)size withSnapBack:(BOOL)withSnapBack delegate:(id)delegate callback:(SEL)method;
