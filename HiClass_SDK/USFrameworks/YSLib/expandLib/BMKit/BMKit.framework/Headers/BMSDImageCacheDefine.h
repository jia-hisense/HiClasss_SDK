...
/// Image Cache Type
typedef NS_ENUM(NSInteger, BMSDImageCacheType) {
    /**
     ...
     */
    BMSDImageCacheTypeAll
};

typedef void(^BMSDImageCacheCheckCompletionBlock)(BOOL isInCache);
typedef void(^BMSDImageCacheQueryDataCompletionBlock)(NSData * _Nullable data);
typedef void(^BMSDImageCacheCalculateSizeBlock)(NSUInteger fileCount, NSUInteger totalSize);
typedef NSString * _Nullable (^BMSDImageCacheAdditionalCachePathBlock)(NSString * _Nonnull key);
typedef void(^BMSDImageCacheQueryCompletionBlock)(UIImage * _Nullable image, NSData * _Nullable data, BMSDImageCacheType cacheType);
typedef void(^BMSDImageCacheContainsCompletionBlock)(BMSDImageCacheType containsCacheType);
 ...
 */
FOUNDATION_EXPORT UIImage * _Nullable BMSDImageCacheDecodeImageData(NSData * _Nonnull imageData, NSString * _Nonnull cacheKey, BMSDWebImageOptions options, BMSDWebImageContext * _Nullable context);
 ...
 */
@protocol BMSDImageCache <NSObject>
 ...
 */
- (nullable id<BMSDWebImageOperation>)queryImageForKey:(nullable NSString *)key
                                             options:(BMSDWebImageOptions)options
                                             context:(nullable BMSDWebImageContext *)context
                                          completion:(nullable BMSDImageCacheQueryCompletionBlock)completionBlock;
...
- (void)containsImageForKey:(nullable NSString *)key
                  cacheType:(BMSDImageCacheType)cacheType
                 completion:(nullable BMSDImageCacheContainsCompletionBlock)completionBlock;
...
/**
 ...
 @param completionBlock A block executed after the operation is finished
 */
- (void)clearWithCacheType:(BMSDImageCacheType)cacheType
                completion:(nullable BMSDWebImageNoParamsBlock)completionBlock;
