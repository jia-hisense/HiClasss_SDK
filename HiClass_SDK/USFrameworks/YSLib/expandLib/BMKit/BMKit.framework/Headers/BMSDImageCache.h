...
/// Image Cache Options
typedef NS_OPTIONS(NSUInteger, BMSDImageCacheOptions) {
    /**
     ...
     */
    BMSDImageCacheQueryMemoryData = 1 << 0,
    /**
     ...
     */
    BMSDImageCacheQueryMemoryDataSync = 1 << 1,
    /**
     ...
     */
    BMSDImageCachePreloadAllFrames = 1 << 6,
    /**
     ...
     */
    BMSDImageCacheMatchAnimatedImageClass = 1 << 7,
};
 ...
 */
@interface BMSDImageCache : NSObject
 ...
 */
@property (nonatomic, copy, nonnull, readonly) BMSDImageCacheConfig *config;
 ...
 */
@property (nonatomic, strong, readonly, nonnull) id<BMSDMemoryCache> memoryCache;
 ...
 */
@property (nonatomic, strong, readonly, nonnull) id<BMSDDiskCache> diskCache;
 ...
 */
@property (nonatomic, copy, nullable) BMSDImageCacheAdditionalCachePathBlock additionalCachePathBlock;
 ...
 */
@property (nonatomic, class, readonly, nonnull) BMSDImageCache *sharedImageCache;
...
- (nonnull instancetype)initWithNamespace:(nonnull NSString *)ns
                       diskCacheDirectory:(nullable NSString *)directory
                                   config:(nullable BMSDImageCacheConfig *)config NS_DESIGNATED_INITIALIZER;
 ...
 *  @note the completion block will be always executed on the main queue
 */
- (void)diskImageDataQueryForKey:(nullable NSString *)key completion:(nullable BMSDImageCacheQueryDataCompletionBlock)completionBlock;
 ...
 */
- (nullable NSOperation *)queryCacheOperationForKey:(nullable NSString *)key done:(nullable BMSDImageCacheQueryCompletionBlock)doneBlock;
 ...
 * @return a NSOperation instance containing the cache op
 */
- (nullable NSOperation *)queryCacheOperationForKey:(nullable NSString *)key options:(BMSDImageCacheOptions)options done:(nullable BMSDImageCacheQueryCompletionBlock)doneBlock;
 ...
 */
@interface BMSDImageCache (SDImageCache) <BMSDImageCache>
