...
#ifndef BMCacheProtocol_h
#define BMCacheProtocol_h

#import <Foundation/Foundation.h>

NS_ASSUME_NONNULL_BEGIN

@protocol BMCacheProtocol;

/**
 A callback block which provides only the cache as an argument
 */
typedef void (^BMCacheBlock)(__kindof id<BMCacheProtocol> cache);

/**
 A callback block which provides the cache, key and object as arguments
 */
typedef void (^BMCacheObjectBlock)(__kindof id<BMCacheProtocol> cache, NSString *key, id _Nullable object);
 ...
 */
typedef void (^BMCacheObjectEnumerationBlock)(__kindof id<BMCacheProtocol> cache, NSString *key, id _Nullable object, BOOL *stop);

/**
 A callback block which provides a BOOL value as argument
 */
typedef void (^BMCacheObjectContainmentBlock)(BOOL containsObject);

@protocol BMCacheProtocol <NSObject>
 ...
 */
- (void)setObjectAsync:(id)object forKey:(NSString *)key completion:(nullable BMCacheObjectBlock)block;
...
/**
 ...
 @param block A block to be executed concurrently after the object has been stored, or nil.
 */
- (void)setObjectAsync:(id)object forKey:(NSString *)key withAgeLimit:(NSTimeInterval)ageLimit completion:(nullable BMCacheObjectBlock)block;
...
/**
 ...
 @param block A block to be executed concurrently after the object has been stored, or nil.
 */
- (void)setObjectAsync:(id)object forKey:(NSString *)key withCost:(NSUInteger)cost completion:(nullable BMCacheObjectBlock)block;
...
/**
 ...
 @param block A block to be executed concurrently after the object has been stored, or nil.
 */
- (void)setObjectAsync:(id)object forKey:(NSString *)key withCost:(NSUInteger)cost ageLimit:(NSTimeInterval)ageLimit completion:(nullable BMCacheObjectBlock)block;
 ...
 */
- (void)removeObjectForKeyAsync:(NSString *)key completion:(nullable BMCacheObjectBlock)block;
 ...
 */
- (void)trimToDateAsync:(NSDate *)date completion:(nullable BMCacheBlock)block;
 ...
 */
- (void)removeExpiredObjectsAsync:(nullable BMCacheBlock)block;
 ...
 */
- (void)removeAllObjectsAsync:(nullable BMCacheBlock)block;
