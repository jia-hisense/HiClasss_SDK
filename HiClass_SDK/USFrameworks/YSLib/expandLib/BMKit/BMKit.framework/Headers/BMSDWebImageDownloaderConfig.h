 ...
 */
@interface BMSDWebImageDownloaderConfig : NSObject <NSCopying>
 ...
 */
@property (nonatomic, class, readonly, nonnull) BMSDWebImageDownloaderConfig *defaultDownloaderConfig;
 ...
 */
@property (nonatomic, assign) BMSDWebImageDownloaderExecutionOrder executionOrder;
